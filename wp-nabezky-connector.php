...
class WP_Nabezky_Connector {
    ...
    public function enqueue_admin_scripts($hook) {
        ...
        wp_localize_script('wp-nabezky-connector-admin', 'nabezky_admin', array(
            ...
            'i18n' => array(
                ...
                'testSuccess' => __('Test Success', 'wp-nabezky-connector'),
                'testFailed' => __('Test Failed', 'wp-nabezky-connector'),
                'testError' => __('Test Error', 'wp-nabezky-connector'),
                'testResults' => __('Test Results', 'wp-nabezky-connector'),
                'responseTime' => __('Response Time', 'wp-nabezky-connector'),
                'configurationValidation' => __('Configuration Validation', 'wp-nabezky-connector'),
                'serverConnectivity' => __('Server Connectivity', 'wp-nabezky-connector'),
                'endpointAvailability' => __('Endpoint Availability', 'wp-nabezky-connector'),
                'errors' => __('Errors:', 'wp-nabezky-connector'),
                'warnings' => __('Warnings:', 'wp-nabezky-connector'),
    ...
    private function send_voucher_email($order_data, $voucher_data) {
        ...
        $message .= '<p>' . sprintf(
            __('This email contains your mapa Na bežky access details. As a bonus with your purchase, you now have access to the premium map with cross-country trails grooming status and other useful information.', 'wp-nabezky-connector'),
            $order_number,
            $eshop_url,
            $voucher_message
        ) . '</p>';
    ...
    private function render_voucher_info($voucher_data) {
        ...
        echo '<p>' . __('As a bonus with your purchase, you now have access to the premium mapa Na bežky with cross-country trails grooming status and other useful information. You can access the map immediately using the button below, or save the details from the email we sent you for later use.', 'wp-nabezky-connector') . '</p>';
